        ...
        <div className="w-full max-w-6xl flex flex-col md:flex-row items-center justify-between gap-8 md:gap-16">
          ...
          <div className="bg-white rounded-2xl shadow-xl p-8 w-full max-w-md">
            <div className="text-center mb-8">
              ...
              <h2 className="text-3xl font-bold text-gray-700">Ro'yxatdan o'tish</h2>
              ...
              <>
                ...
                <div className="mt-8">
                  ...
                  <div className="mt-6 grid grid-cols-2 gap-3">
                    <button
                      type="button"
                      className="w-full inline-flex justify-center py-3 px-4 border border-gray-300 rounded-xl shadow-sm bg-white text-sm font-medium text-gray-600 hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500 transition-colors"
                    >
                    ...
                    >
                      <svg className="w-5 h-5 mr-2" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
                        <path d="M10 0a10 10 0 100 20 10 10 0 000-20zm0 18.75A8.75 8.75 0 1118.75 10 8.76 8.76 0 0110 18.75z"/>
                        <path d="M13.89 9.38h-3.27V7.5a.63.63 0 01.63-.63h1.88V4.38H10.9a3.13 3.13 0 00-3.13 3.12v1.88H5.63v2.5h2.14v6.87h2.5v-6.87h2.14l.48-2.5z"/>
                      </svg>
                      Google
                    </button>
                  </div>
